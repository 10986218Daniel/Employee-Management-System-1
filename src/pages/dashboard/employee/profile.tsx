...
import { User, Mail, Phone, MapPin, Calendar, Edit3, Save, X, Upload, Camera } from 'lucide-react';
...
export default function EmployeeProfile() {
  ...
  const handleImageUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Persist both a generic and a user-specific key
      ...
      // Prefer refreshing context without a full reload
        ...
        >
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>{userProfile?.position || 'Employee'}</CardDescription>
            </CardHeader>
